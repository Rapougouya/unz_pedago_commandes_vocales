                ...
                <div class="card">
                  <div class="card-body dashboard-tabs p-0">
                    <ul class="nav nav-tabs px-4" role="tablist">
                      ...
                      >
                      <a href="{{ route('ues.create')}}" class="btn btn-outline-info">CREER UNE U_E_S</a>
                        ...
                        <tbody>
                            @foreach ($ues as $ues)
                                <tr>
                                    ...
                                    <td>{{ $ues->credit }}</td>
                                    <td>
                                        <form action="{{ route('ues.destroy',$ues->id) }}" method="POST">

                                            <a class="btn btn-primary" href="{{ route('ues.edit',$ues->id) }}">Éditer</a>
                                            @csrf
                                            @method('DELETE')
