                ...
                <div class="card">
                  <div class="card-body dashboard-tabs p-0">
                    <ul class="nav nav-tabs px-4" role="tablist">
                      ...
                      >
                      <a href="{{ route('ufrs.create')}}" class="btn btn-outline-info">CREER UNE UFR</a>
                        ...
                        <tbody>
                            @foreach ($ufrs as $ufr)
                                <tr>
                                    ...
                                    <td>{{ $ufr->nom }}</td>
                                    <td>
                                        <form action="{{ route('ufrs.destroy',$ufr->id) }}" method="POST">
                                            <a class="btn btn-primary" href="{{ route('ufrs.edit',$ufr->id) }}">Modifier</a>
                                            @csrf
                                            @method('DELETE')
